...
namespace TaskAboutComplexNumber.Tests
{
    ...
    public class ComplexNumberTests
    {
        ...
        public void TestAdditionPositiveOnDoubleBorders()
        {
            ComplexNumber excpectedResultOfAddition = new ComplexNumber(1.6e308, 1.6e308);
            ComplexNumber firstComplexNumber = new ComplexNumber(1.6e308, 1.3e308);      
        }
